...
class WPRM_SC_Email_Share extends WPRM_Template_Shortcode {
	...
	public static function shortcode( $atts ) {
		...
		$output = '<a href="' . $mailto_url . '" data-recipe="' . esc_attr( $recipe->id() ) . '" style="' . $style . '" class="' . implode( ' ', $classes ) . '" target="_blank" rel="nofollow">' . $icon . __( $atts['text'], 'wp-recipe-maker' ) . '</a>';
